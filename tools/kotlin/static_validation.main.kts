...
val steps = listOf(
    ...
    StaticStep("validate tool/doc surface", listOf("tools/btm", "internal", "validate-tool-doc-surface")),
    StaticStep("check KubeJS syntax", listOf("tools/btm", "internal", "check-js-syntax")),
    StaticStep("check JSON surface", listOf("tools/btm", "internal", "check-json-surface")),
    StaticStep("validate pack contract", listOf("tools/btm", "internal", "validate-pack-contract")),
    StaticStep("check contract completeness", listOf("tools/btm", "internal", "contract-completeness-report", "--check", "--no-write")),
    StaticStep("validate autonomous contracts", listOf("tools/btm", "internal", "validate-autonomous-contracts")),
    StaticStep(
        ...
        extraEnv = mapOf("OUT_DIR" to "/tmp/btm-indirect-casing-audit"),
    ),
    StaticStep("validate KubeJS assets", listOf("tools/btm", "internal", "validate-kubejs-assets")),
    StaticStep("validate chemistry identity", listOf("tools/btm", "internal", "validate-chemistry-identity")),
    StaticStep("validate synthesis pipeline", listOf("tools/btm", "internal", "validate-synthesis-pipeline")),
    StaticStep("validate player progression contracts", listOf("tools/btm", "internal", "validate-player-progression-contracts")),
