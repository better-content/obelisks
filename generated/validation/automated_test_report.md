...
Generated: 2026-07-06T23:56:44.203943649Z
...
| performance budget: runtime core tag regression validation          | 532.57 ms <= 1500 ms                    |
| latest engine log is recent                                         | 0.05 minutes old                        |
| engine reached dedicated server startup                             |                                         |
| world became playable/servable                                      |                                         |
| spawn preparation budget                                            | 26068 ms <= 60000 ms                    |
| server tick-behind budget                                           | 0 warnings, max 0 ms                    |
| world save budget                                                   | 1203 ms <= 10000 ms                     |
| hard engine log failure scan                                        |                                         |
| performance budget: engine and world performance log analysis       | 503.49 ms <= 750 ms                     |
## Skipped
| Test                                        | Detail                                                  |
| ------------------------------------------- | ------------------------------------------------------- |
