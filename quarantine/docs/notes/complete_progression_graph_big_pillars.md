# Complete Progression Graph — Big Central Pillars
...
flowchart LR
    ...
    %% =====================================
    %% CENTRAL PILLARS / REGIME SHIFTS
    %% =====================================

    MELT["SMELTERY\n+ ALLOYING\n\nfirst real metalworking"]
    ANDE["ANDESITE MACHINE CASING\n\nfirst true machine tier"]
    GRID["GRID POWER\n\nelectric era / pack goes wide"]
    AEPH["AE2 PHASES\n\nlocal intelligence -> controller-era unification"]
    SPACE["SPACE TRAVEL\n\noff-world expansion"]

    %% =====================================
    %% ROOTS / ECONOMIC STARTS
    %% =====================================
    ...
    %% =====================================
    %% CENTRAL SPINE / REGIME-SHIFT VIEW
    %% =====================================
    ...
    %% also tie the detailed chain back into the big presentation nodes
    CW --> ANDE
    LAE2 --> AEPH
    CTRL --> AEPH
    ...
    classDef pillar fill:#ff4d6d,fill-opacity:0.26,stroke:#ff4d6d,stroke-width:4px,color:#fff5f7;
    ...
    class MELT,ANDE,GRID,AEPH,SPACE pillar;
    class CW,BRZ,BRASS,STL,COB,SKY,TNG,NEO,HAF,EUR,TEN,QNT tier;
    class ALLOY,BLOG,MACH,NETH,SKYG,SLUR,OBE,DRAG,POST,EVIL,SYN gate;
    ...
    class SEAR,BCAS,BRCAS,STCAS,SCOR,SKCAS,TGCAS,NECAS,HFCAS,EUCAS,TECAS,QCAS,NPM,BASIC,FIN,ADV,LOGI2 casing;
