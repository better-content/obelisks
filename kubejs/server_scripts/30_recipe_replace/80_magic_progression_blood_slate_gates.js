...
ServerEvents.recipes(function (event) {
    ...
    gate(event, { id: 'occultism:crafting/chalk_white_impure' }, 'minecraft:calcite', BC_OTHERSIDE_T3)
    ...
    gate(event, { output: 'ars_nouveau:source_gem' }, 'minecraft:lapis_lazuli', BC_OTHERSIDE_T3)
    gate(event, { output: 'ars_nouveau:source_gem_block' }, 'ars_nouveau:source_gem', BM_SLATE_T3)
    gate(event, { output: 'ars_nouveau:source_gem_block' }, 'minecraft:amethyst_block', BC_OTHERSIDE_T3)
    gate(event, { id: 'ars_nouveau:imbuement_chamber' }, '#forge:ingots/gold', BM_SLATE_T3)
    gate(event, { id: 'ars_nouveau:imbuement_chamber' }, 'minecraft:archer_pottery_shard', BC_OTHERSIDE_T3)
    ...
    gate(event, { id: 'occultism:ritual/craft_dimensional_mineshaft' }, 'minecraft:ender_eye', BC_OTHERSIDE_T4)

    gate(event, { id: 'forbidden_arcanus:clibano_core' }, 'minecraft:blast_furnace', BM_SLATE_T4)
    gate(event, { id: 'forbidden_arcanus:clibano_core' }, 'forbidden_arcanus:darkstone', BC_OTHERSIDE_T4)
    gate(event, { id: 'forbidden_arcanus:deorum_ingot' }, 'minecraft:gold_ingot', BM_SLATE_T4)
    gate(event, { id: 'forbidden_arcanus:deorum_ingot' }, 'forbidden_arcanus:arcane_crystal', BC_OTHERSIDE_T4)
    ...
    gate(event, { id: 'psi:programmer' }, 'minecraft:redstone', BC_OTHERSIDE_T5)
    gate(event, { id: 'hexcasting:focus' }, 'minecraft:paper', BM_SLATE_T5)
    gate(event, { id: 'hexcasting:focus' }, 'minecraft:amethyst_shard', BC_OTHERSIDE_T5)
