...
Generated: 2026-07-19T12:09:40.586268052Z

Repo: `/home/dev/workspace`

Instance: `/home/dev/.cache/bc/lc-c2me-dh-repro/prepared/server`
...
| performance budget: runtime core tag regression validation          | 505.69 ms <= 1500 ms                    |
| latest engine log is recent                                         | 0.06 minutes old                        |
| engine reached dedicated server startup                             |                                         |
| world became playable/servable                                      |                                         |
| spawn preparation budget                                            | 26957 ms <= 60000 ms                    |
| server tick-behind budget                                           | 0 warnings, max 0 ms                    |
| world save budget                                                   | 1241 ms <= 10000 ms                     |
| hard engine log failure scan                                        |                                         |
| performance budget: engine and world performance log analysis       | 544.92 ms <= 750 ms                     |
## Skipped
| Test                                        | Detail                                                  |
| ------------------------------------------- | ------------------------------------------------------- |
