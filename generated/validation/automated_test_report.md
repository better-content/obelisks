...
Generated: 2026-07-19T10:29:06.810173503Z
...
| performance budget: runtime core tag regression validation          | 518.1 ms <= 1500 ms                     |
| latest engine log is recent                                         | 1.01 minutes old                        |
| engine reached dedicated server startup                             |                                         |
| world became playable/servable                                      |                                         |
| spawn preparation budget                                            | 40073 ms <= 60000 ms                    |
| server tick-behind budget                                           | 0 warnings, max 0 ms                    |
| hard engine log failure scan                                        |                                         |
| performance budget: engine and world performance log analysis       | 516.97 ms <= 750 ms                     |
## Skipped
| Test                                        | Detail                                                  |
| ------------------------------------------- | ------------------------------------------------------- |
