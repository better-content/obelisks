...
Generated: 2026-07-19T10:52:13.826330808Z

Repo: `/home/dev/workspace`

Instance: `/home/dev/.cache/bc/deterministic-seed-smoke`
...
| performance budget: runtime core tag regression validation          | 508.0 ms <= 1500 ms                     |
| latest engine log is recent                                         | 0.06 minutes old                        |
| engine reached dedicated server startup                             |                                         |
| world became playable/servable                                      |                                         |
| spawn preparation budget                                            | 27346 ms <= 60000 ms                    |
| server tick-behind budget                                           | 0 warnings, max 0 ms                    |
| world save budget                                                   | 1305 ms <= 10000 ms                     |
| hard engine log failure scan                                        |                                         |
| performance budget: engine and world performance log analysis       | 537.37 ms <= 750 ms                     |
## Skipped
| Test                                        | Detail                                                  |
| ------------------------------------------- | ------------------------------------------------------- |
