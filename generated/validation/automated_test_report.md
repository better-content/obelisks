...
Generated: 2026-07-19T11:27:38.852751985Z

Repo: `/home/dev/workspace`

Instance: `/home/dev/.cache/bc/opening-progression/prepared/server`
...
| performance budget: runtime core tag regression validation          | 527.24 ms <= 1500 ms                    |
| latest engine log is recent                                         | 0.06 minutes old                        |
| engine reached dedicated server startup                             |                                         |
| world became playable/servable                                      |                                         |
| spawn preparation budget                                            | 28190 ms <= 60000 ms                    |
| server tick-behind budget                                           | 0 warnings, max 0 ms                    |
| world save budget                                                   | 1663 ms <= 10000 ms                     |
| hard engine log failure scan                                        |                                         |
| performance budget: engine and world performance log analysis       | 512.15 ms <= 750 ms                     |
## Skipped
| Test                                        | Detail                                                  |
| ------------------------------------------- | ------------------------------------------------------- |
