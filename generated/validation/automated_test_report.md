...
Generated: 2026-07-18T00:29:03.229152881Z
...
| performance budget: runtime core tag regression validation          | 487.25 ms <= 1500 ms                    |
| latest engine log is recent                                         | 0.06 minutes old                        |
| engine reached dedicated server startup                             |                                         |
| world became playable/servable                                      |                                         |
| spawn preparation budget                                            | 32878 ms <= 60000 ms                    |
| server tick-behind budget                                           | 0 warnings, max 0 ms                    |
| world save budget                                                   | 801 ms <= 10000 ms                      |
| hard engine log failure scan                                        |                                         |
| performance budget: engine and world performance log analysis       | 513.83 ms <= 750 ms                     |
## Skipped
| Test                                        | Detail                                                  |
| ------------------------------------------- | ------------------------------------------------------- |
