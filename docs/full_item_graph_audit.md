...
| bloodmagic           | 772   |
| blue_skies           | 681   |
| buildersaddition     | 676   |
| mcwfurnitures        | 654   |
| ars_nouveau          | 633   |
| mcwroofs             | 607   |
| twigs                | 549   |
| immersive_weathering | 533   |
...
| create:cutting               | 1283  |
| create:mixing                | 1158  |
| alchemistry:dissolver        | 1075  |
| hexerei:woodcutting          | 974   |
| minecraft:smelting           | 667   |
| theurgy:reformation          | 637   |
| mna:manaweaving-recipe       | 530   |
| tconstruct:melting           | 493   |
| tconstruct:casting_table     | 488   |
| tconstruct:material          | 398   |
| alchemistry:combiner         | 389   |
| farmersdelight:cutting       | 336   |
| create:sequenced_assembly    | 310   |
| goety:ritual                 | 292   |
| alchemistry:compactor        | 258   |
| farmersdelight:cooking       | 254   |
| tconstruct:modifier          | 252   |
| theurgy:fermentation         | 250   |
| minecraft:blasting           | 231   |
| tconstruct:modifier_salvage  | 223   |
...
| Output                                              | Recipe                                                                  | Hits                                         |
| --------------------------------------------------- | ----------------------------------------------------------------------- | -------------------------------------------- |
| minecraft:iron_ingot                                | tconstruct:smeltery/casting/metal/iron/ingot_gold_cast                  | minecraft:iron_ingot                         |
| mcwlights:magenta_ceiling_light                     | mcwlights:magenta_ceiling_light                                         | minecraft:redstone                           |
| mna:decoration/gold_arcane_stone                    | mna:manaweaving/decoration/gold_arcane_stone                            | minecraft:gold_ingot                         |
| botania:detector_light_relay                        | botania:detector_light_relay                                            | minecraft:redstone                           |
| minecraft:redstone_torch                            | minecraft:redstone_torch                                                | minecraft:redstone                           |
| botania:pattern_2_1                                 | botania:pattern_2_1                                                     | minecraft:redstone                           |
| botania:pattern_2_2                                 | botania:pattern_2_2                                                     | minecraft:redstone                           |
| botania:pattern_2_3                                 | botania:pattern_2_3                                                     | minecraft:redstone                           |
| minecraft:diamond_block                             | tconstruct:smeltery/casting/diamond/block                               | minecraft:diamond                            |
| ars_elemental:spell_mirror                          | ars_elemental:spell_mirror                                              | minecraft:gold_ingot                         |
| minecraft:gold_ingot                                | theurgy:incubation/ingots_gold_from_alchemical_sulfur_gold              | minecraft:gold_ingot                         |
| mcwlights:redstone_lamp_slab                        | mcwlights:redstone_lamp_slab                                            | minecraft:redstone                           |
| minecraft:iron_ingot                                | forbidden_arcanus:clibano_combustion/iron_ingot_from_clibano_combusting | minecraft:iron_ingot                         |
| goety:spiteful_belt                                 | goety:spiteful_belt                                                     | minecraft:iron_ingot                         |
| createdeco:locked_industrial_iron_door              | createdeco:locked_industrial_iron_door                                  | minecraft:redstone                           |
| create_connected:brake                              | create_connected:crafting/kinetics/brake                                | minecraft:redstone                           |
| botania:pattern_1_1                                 | botania:pattern_1_1                                                     | minecraft:redstone                           |
| botania:pattern_1_2                                 | botania:pattern_1_2                                                     | minecraft:redstone                           |
| botania:pattern_1_3                                 | botania:pattern_1_3                                                     | minecraft:redstone                           |
| minecraft:iron_ingot                                | theabyss:iron_ingot_rcp_2                                               | minecraft:iron_ingot                         |
| minecraft:emerald                                   | blue_skies:emerald_from_blasting_everbright_emerald_ore                 | minecraft:emerald                            |
| framedblocks:framed_fancy_activator_rail            | framedblocks:framing_saw/framed_fancy_activator_rail                    | minecraft:redstone                           |
| createdeco:locked_andesite_door                     | createdeco:locked_andesite_door                                         | minecraft:redstone                           |
| mna:decoration/diamond_arcane_sandstone             | mna:manaweaving/decoration/diamond_arcane_sandstone                     | minecraft:diamond                            |
| mna:constructs/construct_fishing_rod_left_diamond   | mna:eldrin_altar/construct/diamond/diamond_fisher_arm_left              | minecraft:diamond                            |
| forbidden_arcanus:mundabitur_dust                   | forbidden_arcanus:mundabitur_dust                                       | minecraft:redstone                           |
| mna:constructs/construct_shield_arm_right_gold      | mna:manaweaving/constructs/gold/gold_shield_arm_right                   | minecraft:gold_ingot                         |
| tinkers_thinking:chromatic_crystal                  | tinkers_thinking:common/crystal/chromatic_crystal                       | minecraft:amethyst_shard                     |
| minecraft:lapis_lazuli                              | minecraft:lapis_lazuli                                                  | minecraft:lapis_lazuli                       |
| minecraft:iron_ingot                                | immersive_weathering:iron_ingot_from_weathered_block_blasting           | minecraft:iron_ingot                         |
| mna:wand_amethyst                                   | mna:wands/wand_amethyst                                                 | minecraft:amethyst_shard                     |
| advanced_ae:small_adv_pattern_provider              | advanced_ae:smalladvpatpro                                              | minecraft:redstone                           |
| minecraft:emerald_block                             | tconstruct:smeltery/casting/emerald/block                               | minecraft:emerald                            |
| create_connected:kinetic_battery                    | create_connected:crafting/kinetics/kinetic_battery                      | minecraft:redstone                           |
| minecraft:gold_ingot                                | tconstruct:smeltery/casting/metal/gold/ingot_sand_cast                  | minecraft:gold_ingot                         |
| mna:constructs/construct_fluid_nozzle_right_diamond | mna:eldrin_altar/construct/diamond/diamond_nozzle_arm_right             | minecraft:diamond                            |
| mna:decoration/diamond_arcane_stone                 | mna:manaweaving/decoration/diamond_arcane_stone                         | minecraft:diamond                            |
| minecraft:copper_ingot                              | minecraft:copper_ingot                                                  | minecraft:copper_ingot                       |
| minecraft:gilded_blackstone                         | mna:manaweaving/gilded_blackstone                                       | minecraft:gold_ingot                         |
| mna:rune_fire                                       | mna:manaweaving/enchanting/sharpness_v                                  | minecraft:diamond                            |
| minecraft:diamond                                   | create:crushing/deepslate_diamond_ore                                   | minecraft:diamond                            |
| create:experience_nugget                            | create:crushing/deepslate_diamond_ore                                   | minecraft:diamond                            |
| minecraft:cobbled_deepslate                         | create:crushing/deepslate_diamond_ore                                   | minecraft:diamond                            |
| minecraft:lapis_lazuli                              | minecraft:lapis_lazuli_from_blasting_lapis_ore                          | minecraft:lapis_lazuli                       |
| mna:rune_fire                                       | mna:manaweaving/enchanting/sharpness_i                                  | minecraft:iron_ingot                         |
| mna:constructs/construct_caster_arm_left_iron       | mna:manaweaving/constructs/iron/iron_caster_arm_left                    | minecraft:iron_ingot                         |
| tconstruct:reversed_gold_item_frame                 | tconstruct:gadgets/fancy_frame/reversed_gold                            | minecraft:redstone                           |
| minecraft:gold_ingot                                | forbidden_arcanus:clibano_combustion/gold_ingot_from_clibano_combusting | minecraft:gold_ingot                         |
| powergrid:varistor                                  | powergrid:crafting/varistor                                             | minecraft:redstone                           |
| malum:aqueous_spirited_glass                        | malum:spirit_infusion/aqueous_spirited_glass                            | minecraft:iron_ingot                         |
| mna:telekinesis                                     | mna:components/telekinesis                                              | minecraft:iron_ingot, minecraft:copper_ingot |
| mna:resonating_lump                                 | mna:resonating_lump                                                     | minecraft:amethyst_shard                     |
| minecraft:emerald                                   | blue_skies:emerald_from_smelting_everbright_emerald_ore                 | minecraft:emerald                            |
| ae2:calculation_processor                           | ae2:inscriber/calculation_processor                                     | minecraft:redstone                           |
| excessive_building:copper_bulb                      | excessive_building:copper_bulb                                          | minecraft:redstone                           |
| powergrid:regulator_tube                            | powergrid:crafting/regulator_tube                                       | minecraft:amethyst_shard                     |
| mna:constructs/construct_storage_torso_gold         | mna:manaweaving/constructs/gold/gold_torso_storage                      | minecraft:gold_ingot                         |
| botania:hourglass                                   | botania:hourglass                                                       | minecraft:redstone                           |
| theoneprobe:probe                                   | theoneprobe:probe                                                       | minecraft:redstone                           |
| minecraft:emerald                                   | create:crushing/emerald_ore                                             | minecraft:emerald                            |
| create:experience_nugget                            | create:crushing/emerald_ore                                             | minecraft:emerald                            |
| minecraft:cobblestone                               | create:crushing/emerald_ore                                             | minecraft:emerald                            |
| malum:infernal_spirited_glass                       | malum:spirit_infusion/infernal_spirited_glass                           | minecraft:iron_ingot                         |
| mna:rune_arcane                                     | mna:manaweaving/enchanting/ascended_duration_i                          | minecraft:redstone                           |
| theurgy:alchemical_sulfur_lapis                     | theurgy:liquefaction/alchemical_sulfur_lapis_from_gems_lapis            | #forge:gems/lapis                            |
| minecraft:iron_ingot                                | create:blasting/iron_ingot_from_crushed                                 | minecraft:iron_ingot                         |
| createadditionallogistics:package_editor            | createadditionallogistics:crafting/logistics/package_editor             | minecraft:redstone                           |
| theurgy:alchemical_sulfur_redstone                  | theurgy:liquefaction/alchemical_sulfur_redstone_from_dusts_redstone     | #forge:dusts/redstone                        |
| minecraft:diamond                                   | bloodmagic:arc/reversion/weak_blood_orb                                 | minecraft:diamond                            |
| minecraft:detector_rail                             | minecraft:detector_rail                                                 | minecraft:redstone                           |
| mna:constructs/construct_grabber_arm_left_diamond   | mna:eldrin_altar/construct/diamond/diamond_grabber_arm_left             | minecraft:diamond                            |
| mna:constructs/construct_blade_arm_right_iron       | mna:manaweaving/constructs/iron/iron_bladed_arm_right                   | minecraft:iron_ingot                         |
| mna:constructs/construct_fishing_rod_right_gold     | mna:manaweaving/constructs/gold/gold_fisher_arm_right                   | minecraft:gold_ingot                         |
| minecraft:gold_ingot                                | theabyss:gold_ingot_rcp_2                                               | minecraft:gold_ingot                         |
| bloodmagic:voiding_anointment_xl                    | bloodmagic:alchemytable/voiding_anointment_xl                           | minecraft:amethyst_shard                     |
| chipped:tinkering_table                             | chipped:benches/mechanist_workbench                                     | minecraft:redstone                           |
| minecraft:copper_ingot                              | tconstruct:smeltery/casting/metal/copper/ingot_gold_cast                | minecraft:copper_ingot                       |
...
| minecraft:redstone                                  | minecraft:redstone_from_blasting_deepslate_redstone_ore                 | minecraft:redstone                           |
| mcwlights:light_blue_lamp                           | mcwlights:light_blue_lamp                                               | minecraft:redstone                           |
| mna:rune_water                                      | mna:manaweaving/enchanting/aqua_affinity_i                              | minecraft:lapis_lazuli                       |
| mna:constructs/construct_blade_arm_right_diamond    | mna:eldrin_altar/construct/diamond/diamond_bladed_arm_right             | minecraft:diamond                            |
| tinkers_advanced:energy_distributor                 | tinkers_advanced:modifiers/energy_distributor                           | minecraft:redstone                           |
| createdeco:red_brass_lamp                           | createdeco:red_brass_lamp                                               | minecraft:redstone                           |
| minecraft:lapis_lazuli                              | theurgy:incubation/gems_lapis_from_alchemical_sulfur_lapis              | minecraft:lapis_lazuli                       |
| mna:constructs/construct_horn_head_iron             | mna:manaweaving/constructs/iron/iron_head_horn                          | minecraft:iron_ingot                         |
| minecraft:iron_ingot                                | chemlib:iron_ingot_from_smelting_iron_dust                              | minecraft:iron_ingot                         |
| minecraft:diamond_block                             | minecraft:diamond_block                                                 | minecraft:diamond                            |
| mcwlights:green_lamp                                | mcwlights:green_lamp                                                    | minecraft:redstone                           |
| ars_nouveau:manipulation_essence                    | ars_nouveau:imbuement_manipulation_essence                              | minecraft:redstone                           |
| bloodmagic:looting_anointment_xl                    | bloodmagic:alchemytable/looting_anointment_xl                           | minecraft:amethyst_shard                     |
| mcwlights:lime_ceiling_light                        | mcwlights:lime_ceiling_light                                            | minecraft:redstone                           |
| fallout_wastelands_:wastelands                      | fallout_wastelands_:portalignitercraft                                  | minecraft:redstone                           |
| minecraft:emerald_block                             | absentbydesign:reverse/wall_emerald                                     | minecraft:emerald                            |
| mna:rune_earth                                      | mna:manaweaving/enchanting/protection_iii                               | minecraft:gold_ingot                         |
| tconstruct:swiftstrike                              | tconstruct:tools/modifiers/upgrade/swiftstrike_from_block               | minecraft:amethyst_shard                     |
| ars_nouveau:source_gem                              | ars_nouveau:imbuement_amethyst                                          | minecraft:amethyst_shard                     |
| mcwlights:pink_ceiling_light                        | mcwlights:pink_ceiling_light                                            | minecraft:redstone                           |
| theurgy:alchemical_sulfur_diamond                   | theurgy:liquefaction/alchemical_sulfur_diamond_from_gems_diamond        | #forge:gems/diamond                          |
| minecraft:gold_ingot                                | goety:indented_gold/gold_from_indented_gold                             | minecraft:gold_ingot                         |
| botania:pattern_3_1                                 | botania:pattern_3_1                                                     | minecraft:redstone                           |
| botania:pattern_3_2                                 | botania:pattern_3_2                                                     | minecraft:redstone                           |
| create_things_and_misc:magnifying_glass             | create_things_and_misc:magnifyingglass_craft                            | minecraft:amethyst_shard                     |
| mcwlights:red_ceiling_light                         | mcwlights:red_ceiling_light                                             | minecraft:redstone                           |
| minecraft:emerald_block                             | goety:awakened_emerald_block_burner                                     | minecraft:emerald                            |
| mna:rune_aura                                       | mna:manaweaving/enchanting/aura/bulwark_iii                             | minecraft:diamond                            |
| minecraft:diamond_helmet                            | minecraft:diamond_helmet                                                | minecraft:diamond                            |
| minecraft:compass                                   | minecraft:compass                                                       | minecraft:redstone                           |
| minecraft:lapis_lazuli                              | create:crushing/lapis_ore                                               | minecraft:lapis_lazuli                       |
| create:experience_nugget                            | create:crushing/lapis_ore                                               | minecraft:lapis_lazuli                       |
| minecraft:cobblestone                               | create:crushing/lapis_ore                                               | minecraft:lapis_lazuli                       |
