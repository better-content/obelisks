...
Generated: 2026-07-04T13:37:26.255716504Z

Repo: `/home/dev/workspace`

Instance: `/tmp/btm-client-smoke-quick`
...
| spawn preparation budget                                      | 29994 ms <= 60000 ms |
| server tick-behind budget                                     | 0 warnings, max 0 ms |
| world save budget                                             | 1079 ms <= 10000 ms  |
| hard engine log failure scan                                  |                      |
| performance budget: engine and world performance log analysis | 507.28 ms <= 750 ms  |
## Skipped
| Test                                        | Detail                                                  |
| ------------------------------------------- | ------------------------------------------------------- |
