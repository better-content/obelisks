...
Generated: 2026-07-09T06:16:58.673837321Z

Repo: `/home/dev/workspace`

Instance: `/tmp/btm-pc-coin-smoke`
...
| performance budget: runtime core tag regression validation          | 551.93 ms <= 1500 ms                    |
| latest engine log is recent                                         | 0.05 minutes old                        |
| engine reached dedicated server startup                             |                                         |
| world became playable/servable                                      |                                         |
| spawn preparation budget                                            | 26826 ms <= 60000 ms                    |
| server tick-behind budget                                           | 0 warnings, max 0 ms                    |
| world save budget                                                   | 1077 ms <= 10000 ms                     |
| hard engine log failure scan                                        |                                         |
| performance budget: engine and world performance log analysis       | 534.26 ms <= 750 ms                     |
## Skipped
| Test                                        | Detail                                                  |
| ------------------------------------------- | ------------------------------------------------------- |
