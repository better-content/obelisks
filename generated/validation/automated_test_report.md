...
Generated: 2026-07-16T12:33:52.592015429Z

Repo: `/home/dev/workspace`

Instance: `/home/dev/.cache/bc/client-smoke-quick`
...
| performance budget: runtime core tag regression validation          | 496.06 ms <= 1500 ms                    |
| latest engine log is recent                                         | 0.06 minutes old                        |
| engine reached dedicated server startup                             |                                         |
| world became playable/servable                                      |                                         |
| spawn preparation budget                                            | 37094 ms <= 60000 ms                    |
| server tick-behind budget                                           | 0 warnings, max 0 ms                    |
| world save budget                                                   | 926 ms <= 10000 ms                      |
| hard engine log failure scan                                        |                                         |
| performance budget: engine and world performance log analysis       | 516.66 ms <= 750 ms                     |
## Skipped
| Test                                        | Detail                                                  |
| ------------------------------------------- | ------------------------------------------------------- |
