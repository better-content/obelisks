...
Generated: 2026-07-01T22:41:53.875337441Z
...
| Rank   | Test                                                                   | Detail             |
| ------ | ---------------------------------------------------------------------- | ------------------ |
| SHOULD | performance budget exceeded: engine and world performance log analysis | 658.14 ms > 250 ms |
## Passes
| Test                                    | Detail               |
| --------------------------------------- | -------------------- |
...
| spawn preparation budget                | 40031 ms <= 60000 ms |
| server tick-behind budget               | 0 warnings, max 0 ms |
| world save budget                       | 1625 ms <= 10000 ms  |
