...
Generated: 2026-07-04T02:20:28.251222789Z

Repo: `/home/dev/workspace`

Instance: `/tmp/btm-client-smoke-release`
...
| spawn preparation budget                                      | 31837 ms <= 60000 ms |
| server tick-behind budget                                     | 0 warnings, max 0 ms |
| world save budget                                             | 1235 ms <= 10000 ms  |
| hard engine log failure scan                                  |                      |
| performance budget: engine and world performance log analysis | 500.78 ms <= 750 ms  |
## Skipped
| Test                                        | Detail                                                  |
| ------------------------------------------- | ------------------------------------------------------- |
